...
public class Battleship2 extends Ship {
    ...
    public Battleship2(int x, int y) {
        super(x, y);
    }
    ...
    public static int[][] getMissedGuesses() {
    ...
    public static void deployPlayerShips(){
        ...
        */
        Battleship2.playerShips = 5;
        for (int i = 1; i <= Battleship2.playerShips; ) {
    ...
    public static void deployComputerShips(){
        ...
        Battleship2.computerShips = 5;
        for (int i = 1; i <= Battleship2.computerShips; ) {
    ...
    public static void Battle(){
        ...
        System.out.println();
        System.out.println("Your ships: " + Battleship2.playerShips + " | Computer ships: " + Battleship2.computerShips);
        System.out.println();
    }
        ...
        do {
            ...
            if ((x >= 0 && x < numRows) && (y >= 0 && y < numCols)) //valid guess
            {
                if (grid[x][y] == "x") //if computer ship is already there; computer loses ship
                {
                    ...
                    grid[x][y] = "!"; //Hit mark
                    --Battleship2.computerShips;
                }
                else if (grid[x][y] == "@") {
                    System.out.println("Oh no, you sunk your own ship :(");
                    grid[x][y] = "x";
                    --Battleship2.playerShips;
                    ++Battleship2.computerShips;
                }
                else if (grid[x][y] == " ") {
    ...
    public static void gameOver(){
        System.out.println("Your ships: " + Battleship2.playerShips + " | Computer ships: " + Battleship2.computerShips);
        if(Battleship2.playerShips > 0 && Battleship2.computerShips <= 0)
